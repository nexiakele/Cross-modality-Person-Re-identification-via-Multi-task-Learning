...
if __name__ == '__main__':
    ...
    r_pos, t_pos = GenIdx( train_color_label, train_thermal_label)
    sampler = IdentitySampler(train_color_label, train_thermal_label, r_pos, t_pos, 8)
    print(sampler.index1.shape)